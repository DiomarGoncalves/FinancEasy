...
async function filtrarReceitas() {
  ...
  Receitas.forEach((Receitas) => {
    ...
    row.innerHTML = `
                ...
                `;
    tableBody.appendChild(row); // Adicionar linha à tabela
    totalReceitas += Receitas.valor; // Atualizar total de Receitas
  });
  document.getElementById(
    "totalReceitas"
...
//   // Obtém os elementos de entrada de receita e despesa
...
//   let totalReceitas = 0;
//   receitas.forEach((receita) => {
//     totalReceitas += parseFloat(receita.textContent) || 0;
//   });

//   // Calcula o total de despesas
//   let totalDespesas = 0;
//   despesas.forEach((despesa) => {
//     totalDespesas += parseFloat(despesa.textContent) || 0;
//   });

//   // Calcula o saldo
//   const saldo = totalReceitas - totalDespesas;

//   // Exibe o saldo em um elemento com id 'saldo'
